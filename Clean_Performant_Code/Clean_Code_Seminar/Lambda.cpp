...
namespace Lambdas {
    ...
    static bool compare(int n1, int n2) {
        std::cout << "in Compare:" << n1 << " mit " << n2 << std::endl;
        return n1 < n2;
    }
    ...
    public:
        ...
        bool operator() (int n1, int n2) const {
            std::cout << "in operator():" << n1 << " mit " << n2 << std::endl;
    ...
    static void test_03()
    {
        ...
        public:
            ...
            bool operator() (int n1, int n2) const {
                std::cout << "in LocalComparer operator():" << n1 << " mit " << n2 << std::endl;
                return (m_flag) ? n1 < n2 : n1 > n2;
            }
        };
    ...
    static void test_07() {
     ...
     //   variable = 999;
        ...
        std::vector vec2 { 5, 6, 4, 1, 3, 2, 7, 8 };

        // Wrapper Klasse:  std::function
        std::function< int () > lambda2 = [=, variable = 123]() mutable -> int {
